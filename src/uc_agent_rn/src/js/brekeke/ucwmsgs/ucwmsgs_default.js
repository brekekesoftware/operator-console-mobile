...
window.Brekeke.UCWMsgs = window.Brekeke.UCWMsgs_default = {
  ...
  MSG_ENTER_WEBCHAT_ROOM_OK: 'You have joined the chat.',
  MSG_ENTER_WEBCHAT_ROOM_ERROR: 'Error. (Failed to join the chat.)',
  ...
  LBL_EDITOR_TEXT_FIELD_PLACEHOLDER: 'Enter message here.',
