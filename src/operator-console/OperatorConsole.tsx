...
const LegacyCallTalkingButton = props => <CommonButton {...props} />

const LegacyNoAnswerButton = props => (
  <CommonButton {...props} onPress={props.context.toggleAutoRejectIncoming} />
)
const LegacyCallbackButton = props => <CommonButton {...props} />
const LegacyTransferButton = props => (
  <CommonButton
    {...props}
...
const LegacyToggleRecordingButton = props => (
  <CommonButton
    {...props}
...
const LegacyAlarmButton = props => (
  <CommonButton {...props} className='kbc-button kbc-button-fill-parent' />
)
const LegacyPrevCallButton = props => {
...
const LegacyMonitorDialingExtensionButton = props => (
  <CommonButton
    {...props}
...
const LegacyStationLineDesignationButton = props => (
  <CommonButton {...props} className='kbc-button kbc-button-fill-parent' />
)
const LegacyParkCallButton = props => {
...
const LegacySeriesSetButton = props => (
  <CommonButton {...props} className='kbc-button kbc-button-fill-parent' />
)
const LegacyMonitoringCallButton = props => (
  <CommonButton
    {...props}
    className={clsx(
      'kbc-button kbc-button-fill-parent',
...
const LegacyStartButton = props => (
  <CommonButton {...props} className='kbc-button kbc-button-fill-parent' />
)
const LegacyToggleMutedButton = props => {
...
const LegacyLeavingSeatButton = props => (
  <CommonButton {...props} className='kbc-button kbc-button-fill-parent' />
)
const LegacyNightTimeButton = props => (
  <CommonButton {...props} className='kbc-button kbc-button-fill-parent' />
)
const LegacyAvailableButton = props => (
  <CommonButton {...props} className='kbc-button kbc-button-fill-parent' />
)
const LegacyNextCallButton = props => {
...
const LegacyKeypadButton = props => (
  <CommonButton
    {...props}
    onPress={() => {
...
const _getQuickCallDialingBySymbol = (symbol, quickCallWidget) => {
  if (!quickCallWidget) {
    return null
  }
  if (symbol === '0') {
...
const LegacyMakeCallButton = props => (
  <CommonButton
    {...props}
    className='kbc-button kbc-button-fill-parent'
    onPress={() => {
...
const LegacyBackspaceButton = props => (
  <CommonButton
    {...props}
...
const LegacyIncomingCallButton = props => {
  // const { currentCallIndex, callIds = [], callById = {} } = context;
  // const currentCall = callById[callIds[currentCallIndex]];
  const currentCallInfo = props.operatorConsoleAsParent
    .getPhoneClient()
...
const LegacyThreeWayCallButton = props => (
  <CommonButton
    {...props}
    className='kbc-button kbc-button-fill-parent'
...
function LegacyOutgoingCallButton(props) {
  // const { currentCallIndex, callIds = [], callById = {} } = context;
  // const currentCall = callById[callIds[currentCallIndex]];
  const currentCallInfo = props.operatorConsoleAsParent
    .getPhoneClient()
...
function LegacyHangUpCallButton(props) {
  const currentCallInfo = props.operatorConsoleAsParent
    .getPhoneClient()
    .getCallInfos()
    .getCurrentCallInfo()
...
function LegacyUnholdCallButton(props) {
  // const { currentCallIndex, callIds = [], callById = {} } = context;
  // const currentCall = callById[callIds[currentCallIndex]];
  const currentCallInfo = props.operatorConsoleAsParent
    .getPhoneClient()
...
function LegacyHoldCallButton(props) {
  const currentCallInfo = props.operatorConsoleAsParent
    .getPhoneClient()
    .getCallInfos()
    .getCurrentCallInfo()
...
function LegacyPickUpCallButton(props) {
  // const { currentCallIndex, callIds = [], callById = {} } = context;
  // const currentCall = callById[callIds[currentCallIndex]];
  const currentCallInfo = props.operatorConsoleAsParent
    .getPhoneClient()
...
export function getIconJsx(icon, label) {
  let iconJsx
  if (!icon) {
    iconJsx = label
...
function LegacyDummyButton(props) {
  return (
    <CommonButton {...props} className='kbc-button kbc-button-fill-parent' />
  )
}
function LegacyQuickCallButton(props) {
  return (
    <CommonButton
      {...props}
      className={clsx(
...
function LegacyAutoDialButton(props) {
  const isRedColor =
...
function LegacyOneTouchDialButton(props) {
  if (!props.context) {
    return (
      <CommonButton
        {...props}
...
function CallTable(props) {
  ...
  return (
    <div
      className='brOCCalltableWrapper'
      data-broc-widgetindex={props.widgetIndex}
    >
      <table
        ...
        >
          {callInfoArray.map((callInfo, i) => {
            ...
            if (isEditMode) {
              ...
              tdActive = (
                <div style={{ width: 42, height: 42, margin: '0 auto' }}>
                  <button
                    title={i18n.t('activeButtonDesc')}
                    className='kbc-button kbc-button-fill-parent'
                    style={{ fontSize: activeButtonFontSize }}
                    onClick={() => context.switchCallIndex(i)}
                  >
                    {i18n.t('active')}
                  </button>
                </div>
