      ...
      /*#__PURE__*/ (function () {
        var _ref2 = _asyncToGenerator(
          /*#__PURE__*/ _regenerator().m(function _callee2(url, fileName) {
            var dirs, dirToSave, filePath, configOptions, response, _t2
            return _regenerator().w(
              function (_context2) {
                while (1)
                  switch (_context2.n) {
                    case 0:
                      dirs = _rnFetchBlob.default.fs.dirs
                      dirToSave =
                        _reactNative.Platform.OS === 'ios'
                          ? dirs.DocumentDir
                          : dirs.DownloadDir
                      filePath = ''.concat(dirToSave, '/').concat(fileName)
                      _context2.p = 1
                      configOptions = _reactNative.Platform.select({
                        ios: {
                          fileCache: true,
                          path: filePath,
                    ...
                    case 2:
                      ...
                      _context2.n = 3
                      return _rnFetchBlob.default.ios.previewDocument(
                        response.path(),
                      )
                    case 3:
                      _context2.n = 5
                    ...
                    case 4:
                      _context2.p = 4
                      _t2 = _context2.v
                      console.error('Error downloading file:', _t2)
                    case 5:
