...
var DocumentPicker = _interopRequireWildcard(
...
function _interopRequireWildcard(e, t) {
  ...
  return (_interopRequireWildcard = function _interopRequireWildcard(e, t) {
    ...
    for (var _t3 in e)
      'default' !== _t3 &&
        {}.hasOwnProperty.call(e, _t3) &&
        ((i =
          (o = Object.defineProperty) &&
          Object.getOwnPropertyDescriptor(e, _t3)) &&
        (i.get || i.set)
          ? o(f, _t3, i)
          : (f[_t3] = e[_t3]))
    return f
      ...
      value: (function () {
        var _handleBgColorEditImportButtonClick = _asyncToGenerator(
          /*#__PURE__*/ _regenerator().m(function _callee() {
            var props, result, fileContent, _t
                ...
                while (1)
                  switch (_context.n) {
                    ...
                    case 2:
                      result = _context.v
                      _context.n = 3
                      return FileSystem.readFile(result[0].uri)
                    case 3:
      ...
      value: (function () {
        var _handleBgColorEditExportButtonClick = _asyncToGenerator(
          /*#__PURE__*/ _regenerator().m(function _callee2() {
            var props, preferenceWork, fileName, path, _t2
            return _regenerator().w(
              function (_context2) {
                while (1)
                  switch (_context2.n) {
                    ...
                    case 6:
                      _context2.p = 6
                      _t2 = _context2.v
                      props.uiData.ucUiStore.getLogger().log('warn', _t2)
                    case 7:
                      return _context2.a(2)
                  }
              },
