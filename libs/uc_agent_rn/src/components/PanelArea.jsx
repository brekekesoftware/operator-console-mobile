...
import PanelHeaderHideButton from './PanelHeaderHideButton'
import PanelHeaderUndockButton from './PanelHeaderUndockButton'
import PanelHeaderHideSubButton from './PanelHeaderHideSubButton'
import PanelHeaderDockButton from './PanelHeaderDockButton'
import PanelHeaderCloseChatButton from './PanelHeaderCloseChatButton'
import PanelHeaderRejoinButton from './PanelHeaderRejoinButton'
import ChatPanel from './ChatPanel'
import PreferencePanel from './PreferencePanel'
import WebchatQueuePanel from './WebchatQueuePanel'
import HistorySearchPanel from './HistorySearchPanel'
import HistorySummariesPanel from './HistorySummariesPanel'
      ...
      if (
        ...
        headerButtons.push(
          <ButtonIconic
            ...
            iconSource={<LogOutIcon color='#ffffff' />}
          >
        ...
        if (
          ...
          headerButtons.push(
            <ButtonIconic
              ...
              iconSource={<ReplyIcon color='#ffffff' />}
            >
              {/* <View style={styles.brPanelHeaderButtonIcon} /> */}
            </ButtonIconic>,
          )
      ...
      if (
        ...
        headerButtons.push(
          <ButtonIconic
            ...
            iconSource={<EnvelopeIcon color='#ffffff' />}
          >
            {/* <View style={styles.brPanelHeaderButtonIcon} /> */}
          </ButtonIconic>,
        )
        ...
        if (
          ...
          headerButtons.push(
            <ButtonIconic
              ...
              iconSource={<UploadIcon color='#ffffff' />}
            >
              {/* <View style={styles.brPanelHeaderButtonIcon} /> */}
            </ButtonIconic>,
          )
      ...
      if (
        ...
        headerButtons.push(
          <ButtonIconic
            ...
            iconSource={<PhoneIcon color='#ffffff' />}
          >
            {/* <View style={styles.brPanelHeaderButtonIcon} /> */}
          </ButtonIconic>,
        )
      ...
      if (
        ...
        headerButtons.push(
          <ButtonIconic
            ...
            iconSource={<VideoCallIcon color='#ffffff' />}
          >
            {/* <View style={styles.brPanelHeaderButtonIcon} /> */}
          </ButtonIconic>,
        )
      ...
      if (
        ...
        headerButtons.push(
          <ButtonIconic
            ...
            iconSource={<ChannelMosaic1Icon color='#ffffff' />}
          >
            {/* <View style={styles.brPanelHeaderButtonIcon} /> */}
          </ButtonIconic>,
        )
      ...
      if (
        ...
        headerButtons.push(
          <ButtonIconic
            ...
            iconSource={<HistoryIcon color='#ffffff' />}
          >
            {/* <View style={styles.brPanelHeaderButtonIcon} /> */}
          </ButtonIconic>,
        )
      ...
      if (
        ...
        headerButtons.push(
          <ButtonIconic
            ...
            iconSource={<ChatIcon color='#ffffff' />}
          >
            {/* <View style={styles.brPanelHeaderButtonIcon} /> */}
          </ButtonIconic>,
        )
      ...
      >
        ...
        <View
          ...
          style={[
            ...
            props.panelType === 'HISTORYSEARCH' ? { zIndex: 1 } : {},
          ]}
        >
          <Text
