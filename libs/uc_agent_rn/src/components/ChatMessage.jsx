...
import ChatFileDownloadButton from './ChatFileDownloadButton'
import ChatFileDownloadLargeButton from './ChatFileDownloadLargeButton'
import { formatStr, formatFileSize, formatTime } from '../utilities/strings'
import {
  View,
  Text,
  StyleSheet,
