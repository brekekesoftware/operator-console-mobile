...
import SearchConditionsArea from './SearchConditionsArea'
...
export default class HistorySearchPanel extends React.Component {
 ...
 const rect = this.containerRef.current.getBoundingClientRect()
        console.log('#Duy Phan console get wh111',this.containerRef.current.clientHeight, rect)
      this.setState({ panelHeight: rect.height })
    })
  ...
  render() {
    ...
    return (
      <View style={styles.brHistorySearchPanel} ref={this.containerRef}>
        <View
