...
const DndSort = ({ onDragEnd, data, renderItem }) => {
...
export default class extends React.Component {
  ...
  handleDragEnd = ({ active, over }) => {
    ...
    if (active.id !== over.id) {
      ...
      let newPanelList = [...props.uiData.mainPanelList]
      const activeIndex = newPanelList.findIndex(
        i => i.panelType + '_' + i.panelCode === active.id,
      )
      const overIndex = newPanelList.findIndex(
        i => i.panelType + '_' + i.panelCode === over?.id,
      )

      const tabData1 = newPanelList[activeIndex]
      const tabData2 = newPanelList[overIndex]
