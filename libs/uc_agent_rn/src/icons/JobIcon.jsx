...
const JobIcon = ({ width = 24, height = 24, color = '#212121', ...props }) => (
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2f5xber1zp' fill='white'>
        <Use xlinkHref='#path-1f5xber1zp'></Use>
      </Mask>
      <Use xlinkHref='#path-1f5xber1zp' />
      <Use
        id='Shapef5xber1zp'
        fill='#191919'
        fillRule='nonzero'
    ...
    >
      ...
      <Rect id='Rectanglef5xber1zp' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
