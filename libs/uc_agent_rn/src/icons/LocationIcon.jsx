...
const LocationIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2qowwwwbh4' fill='white'>
        <Use xlinkHref='#path-1qowwwwbh4'></Use>
      </Mask>
      <Use xlinkHref='#path-1qowwwwbh4' />
      <Use
        id='Shapeqowwwwbh4'
        fill='#191919'
        fillRule='nonzero'
        xlinkHref='#path-1qowwwwbh4'
      />
    </Defs>
    <G
      id='icon/locationqowwwwbh4'
      fill='none'
      mask='url(#mask-2qowwwwbh4)'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    >
      ...
      <Rect id='Rectangleqowwwwbh4' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
