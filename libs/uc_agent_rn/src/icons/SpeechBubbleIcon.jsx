...
const SpeechBubbleIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-28mktpgf4n' fill='white'>
        <Use xlinkHref='#path-18mktpgf4n'></Use>
      </Mask>
      <Use xlinkHref='#path-18mktpgf4n' />
    </Defs>
    <G
      id='icon/speech_bubble8mktpgf4n'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/black8mktpgf4n'
      fill='#212121'
      mask='url(#mask-28mktpgf4n)'
    >
      <Rect id='Rectangle8mktpgf4n' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
