...
const TagIcon = ({ width = 24, height = 24, color = '#212121', ...props }) => (
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2w3snemyqg' fill='white'>
        <Use xlinkHref='#path-1w3snemyqg'></Use>
      </Mask>
      <Use xlinkHref='#path-1w3snemyqg' />
      <Use
        id='Shapew3snemyqg'
        fill='#191919'
        fillRule='nonzero'
    ...
    >
      ...
      <Rect id='Rectanglew3snemyqg' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
