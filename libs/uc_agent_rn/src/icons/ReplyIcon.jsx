...
const ReplyIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-25awe46bbv' fill='white'>
        <Use xlinkHref='#path-15awe46bbv'></Use>
      </Mask>
      <Use xlinkHref='#path-15awe46bbv' />
    </Defs>
    <G
      id='icon/about5awe46bbv'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/black5awe46bbv'
      fill='#212121'
      mask='url(#mask-25awe46bbv)'
    >
      <Rect id='Rectangle5awe46bbv' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
