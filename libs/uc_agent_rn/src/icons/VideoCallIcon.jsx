...
const VideoCallIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2kmoni49jk' fill='white'>
        <Use xlinkHref='#path-1kmoni49jk'></Use>
      </Mask>
      <Use xlinkHref='#path-1kmoni49jk' />
    </Defs>
    <G
    ...
    >
      <Rect id='Rectanglekmoni49jk' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
