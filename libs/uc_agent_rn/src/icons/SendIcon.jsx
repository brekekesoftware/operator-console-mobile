...
const SendIcon = ({ width = 24, height = 24, color = '#212121', ...props }) => (
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2r9km86i97' fill='white'>
        <Use xlinkHref='#path-1r9km86i97'></Use>
      </Mask>
      <Use xlinkHref='#path-1r9km86i97' />
    </Defs>
    <G
      id='icon/sendr9km86i97'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/blackr9km86i97'
      fill='#212121'
      mask='url(#mask-2r9km86i97)'
    >
      <Rect id='Rectangler9km86i97' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
