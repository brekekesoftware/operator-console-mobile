...
const CollapseIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2yoxlp6m9r' fill='white'>
        <Use xlinkHref='#path-1yoxlp6m9r'></Use>
      </Mask>
      <Use xlinkHref='#path-1yoxlp6m9r' />
    </Defs>
    <G
      id='icon/collapseyoxlp6m9r'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/blackyoxlp6m9r'
      fill='#212121'
      mask='url(#mask-2yoxlp6m9r)'
    >
      <Rect id='Rectangleyoxlp6m9r' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
