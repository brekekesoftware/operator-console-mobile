...
const MoreIcon = ({ width = 24, height = 24, color = '#212121', ...props }) => (
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-25xvz7coc3' fill='white'>
        <Use xlinkHref='#path-15xvz7coc3'></Use>
      </Mask>
      <Use xlinkHref='#path-15xvz7coc3' />
    </Defs>
    <G
      id='icon/more5xvz7coc3'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/black5xvz7coc3'
      fill='#212121'
      mask='url(#mask-25xvz7coc3)'
    >
      <Rect id='Rectangle5xvz7coc3' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
