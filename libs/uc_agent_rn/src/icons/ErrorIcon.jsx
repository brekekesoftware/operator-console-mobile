...
const ErrorIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2mtww1ine9' fill='white'>
        <Use xlinkHref='#path-1mtww1ine9'></Use>
      </Mask>
      <Use xlinkHref='#path-1mtww1ine9' />
      <Use
        id='Shapemtww1ine9'
        fill='#191919'
        fillRule='nonzero'
        xlinkHref='#path-1mtww1ine9'
      />
    </Defs>
    <G
      id='icon/errormtww1ine9'
      fill='none'
      mask='url(#mask-2mtww1ine9)'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    >
      ...
      <Rect id='Rectanglemtww1ine9' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
