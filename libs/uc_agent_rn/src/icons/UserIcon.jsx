...
const UserIcon = ({ width = 24, height = 24, color = '#212121', ...props }) => (
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2xgez71fg3' fill='white'>
        <Use xlinkHref='#path-1xgez71fg3'></Use>
      </Mask>
      <Use xlinkHref='#path-1xgez71fg3' />
    </Defs>
    <G
      id='icon/userxgez71fg3'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/blackxgez71fg3'
      fill='#212121'
      mask='url(#mask-2xgez71fg3)'
    >
      <Rect id='Rectanglexgez71fg3' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
