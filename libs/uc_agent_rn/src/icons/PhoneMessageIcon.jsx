...
const PhoneMessageIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-26s210ns1v' fill='white'>
        <Use xlinkHref='#path-16s210ns1v'></Use>
      </Mask>
      <Use xlinkHref='#path-16s210ns1v' />
    </Defs>
    <G
      id='icon/phone-message6s210ns1v'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/black6s210ns1v'
      fill='#212121'
      mask='url(#mask-26s210ns1v)'
    >
      <Rect id='Rectangle6s210ns1v' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
