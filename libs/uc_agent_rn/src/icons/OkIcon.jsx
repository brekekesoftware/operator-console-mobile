...
const OkIcon = ({ width = 24, height = 24, color = '#212121', ...props }) => (
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2ww9k817sw' fill='white'>
        <Use xlinkHref='#path-1ww9k817sw'></Use>
      </Mask>
      <Use xlinkHref='#path-1ww9k817sw' />
    </Defs>
    <G
      id='icon/okww9k817sw'
      fill='none'
    ...
    <G
      id='colors/default/blackww9k817sw'
      fill='#212121'
      mask='url(#mask-2ww9k817sw)'
    >
      <Rect id='Rectangleww9k817sw' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
