...
const RssIcon = ({ width = 24, height = 24, color = '#212121', ...props }) => (
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2lwems3ub6' fill='white'>
        <Use xlinkHref='#path-1lwems3ub6'></Use>
      </Mask>
      <Use xlinkHref='#path-1lwems3ub6' />
      <Use
        id='Shapelwems3ub6'
        fill='#191919'
        fillRule='nonzero'
        xlinkHref='#path-1lwems3ub6'
      />
    </Defs>
    <G
      id='icon/rsslwems3ub6'
      fill='none'
      mask='url(#mask-2lwems3ub6)'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    >
      ...
      <Rect id='Rectanglelwems3ub6' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
