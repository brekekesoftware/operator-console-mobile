...
const EndCallIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2i7a3grq66' fill='white'>
        <Use xlinkHref='#path-1i7a3grq66'></Use>
      </Mask>
      <Use xlinkHref='#path-1i7a3grq66' />
    </Defs>
    <G
      id='icon/end_calli7a3grq66'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/blacki7a3grq66'
      fill='#212121'
      mask='url(#mask-2i7a3grq66)'
    >
      <Rect id='Rectanglei7a3grq66' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
