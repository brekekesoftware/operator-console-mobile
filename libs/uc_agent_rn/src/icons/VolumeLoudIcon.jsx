...
const VolumeLoudIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-24fiwmwof3' fill='white'>
        <Use xlinkHref='#path-14fiwmwof3'></Use>
      </Mask>
      <Use xlinkHref='#path-14fiwmwof3' />
      <Use
        id='Shape4fiwmwof3'
        fill='#191919'
        fillRule='nonzero'
        xlinkHref='#path-14fiwmwof3'
      />
    </Defs>
    <G
      id='icon/volume-loud4fiwmwof3'
      fill='none'
      mask='url(#mask-24fiwmwof3)'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    >
      ...
      <Rect id='Rectangle4fiwmwof3' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
