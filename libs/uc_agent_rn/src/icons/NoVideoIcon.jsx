...
const NoVideoIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2jdcpyva5d' fill='white'>
        <Use xlinkHref='#path-1jdcpyva5d'></Use>
      </Mask>
      <Use xlinkHref='#path-1jdcpyva5d' />
    </Defs>
    <G
      id='icon/no-videojdcpyva5d'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/blackjdcpyva5d'
      fill='#212121'
      mask='url(#mask-2jdcpyva5d)'
    >
      <Rect id='Rectanglejdcpyva5d' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
