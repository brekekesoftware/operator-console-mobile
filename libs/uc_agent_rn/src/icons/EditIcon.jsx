...
const EditIcon = ({ width = 24, height = 24, color = '#212121', ...props }) => (
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2rmk8rnzwn' fill='white'>
        <Use xlinkHref='#path-1rmk8rnzwn'></Use>
      </Mask>
      <Use xlinkHref='#path-1rmk8rnzwn' />
    </Defs>
    <G
      id='icon/editrmk8rnzwn'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/blackrmk8rnzwn'
      fill='#212121'
      mask='url(#mask-2rmk8rnzwn)'
    >
      <Rect id='Rectanglermk8rnzwn' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
