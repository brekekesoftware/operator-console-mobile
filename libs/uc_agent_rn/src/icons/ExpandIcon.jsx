...
const ExpandIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2h8d2kkppd' fill='white'>
        <Use xlinkHref='#path-1h8d2kkppd'></Use>
      </Mask>
      <Use xlinkHref='#path-1h8d2kkppd' />
    </Defs>
    <G
      id='icon/expandh8d2kkppd'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/blackh8d2kkppd'
      fill='#212121'
      mask='url(#mask-2h8d2kkppd)'
    >
      <Rect id='Rectangleh8d2kkppd' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
