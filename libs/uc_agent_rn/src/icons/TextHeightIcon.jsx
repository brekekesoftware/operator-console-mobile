...
const TextHeightIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2bxg8kph9h' fill='white'>
        <Use xlinkHref='#path-1bxg8kph9h'></Use>
      </Mask>
      <Use xlinkHref='#path-1bxg8kph9h' />
    </Defs>
    <G
      id='icon/text-heightbxg8kph9h'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/blackbxg8kph9h'
      fill='#212121'
      mask='url(#mask-2bxg8kph9h)'
    >
      <Rect id='Rectanglebxg8kph9h' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
