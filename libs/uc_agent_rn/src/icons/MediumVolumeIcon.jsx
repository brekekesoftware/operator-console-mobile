...
const MediumVolumeIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-24pqcgzutb' fill='white'>
        <Use xlinkHref='#path-14pqcgzutb'></Use>
      </Mask>
      <Use xlinkHref='#path-14pqcgzutb' />
    </Defs>
    <G
      id='icon/medium_volume4pqcgzutb'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/black4pqcgzutb'
      fill='#212121'
      mask='url(#mask-24pqcgzutb)'
    >
      <Rect id='Rectangle4pqcgzutb' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
