...
const SpeakerIcon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2ynr61oxtx' fill='white'>
        <Use xlinkHref='#path-1ynr61oxtx'></Use>
      </Mask>
      <Use xlinkHref='#path-1ynr61oxtx' />
    </Defs>
    <G
      id='icon/speakerynr61oxtx'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/blackynr61oxtx'
      fill='#212121'
      mask='url(#mask-2ynr61oxtx)'
    >
      <Rect id='Rectangleynr61oxtx' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
