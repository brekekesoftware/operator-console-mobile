...
const ChannelMosaic12Icon = ({
  ...
  <Svg width={width} height={height} viewBox='0 0 24 24' {...props}>
    <Defs>
      ...
      />
      <Mask id='mask-2b6mq8jscn' fill='white'>
        <Use xlinkHref='#path-1b6mq8jscn'></Use>
      </Mask>
      <Use xlinkHref='#path-1b6mq8jscn' />
    </Defs>
    <G
      id='icon/channel-mosaic-1-2b6mq8jscn'
      fill='none'
      fillRule='evenodd'
      stroke='none'
      strokeWidth='1'
    ...
    <G
      id='colors/default/blackb6mq8jscn'
      fill='#212121'
      mask='url(#mask-2b6mq8jscn)'
    >
      <Rect id='Rectangleb6mq8jscn' x='0' y='0' width='24' height='24'></Rect>
    </G>
  </Svg>
)
